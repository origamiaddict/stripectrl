...
(function($){
	...
	var defaultOptions = {
			...
			parent: "",
			//wrap: '<div style="position: absolute;z-index: 10; background:#ffc;padding:5px;border:1px solid #CCCCCC;text-align:center;width:100%text-align: center;vertical-align: middle;"></div>'
			wrap: '<div style="height: 300px; left: 0; overflow: hidden; position: absolute; top: 0;width: 300px; margin: 0;"></div>'
