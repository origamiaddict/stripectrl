...
$._farbtastic = function (container, options) {
  ...
  fb.widgetCoords = function (event) {
    ...
    return {
      x: touch.pageX - fb.offset.left - fb.mid,    
      y: touch.pageY - fb.offset.top - fb.mid
    };    
  }
  ...
  fb.mousedown = function (event) {
    ...
    if (!$._farbtastic.dragging) {
      //CUSTOM:
      $('.farbtastic').bind((isIPhone ? "touchmove" : "mousemove"), fb.mousemove);
      $('.farbtastic').bind((isIPhone ? "touchend" : "mouseup"), fb.mouseup);      	
      //OLD:
  ...
  fb.mouseup = function () {
    // Uncapture mouse
    $('.farbtastic').unbind((isIPhone ? "touchmove" : "mousemove"), fb.mousemove);
    $('.farbtastic').unbind((isIPhone ? "touchend" : "mouseup"), fb.mouseup);
